package com.qa.addProductsDevTest.util;
...
import com.qa.addProductsDevTest.ExtentReportsListeners.ExtentReportListener;
...
public class TestBase extends ExtentReportListener{
	...
	public TestBase() {
		try {
			prop = new Properties();
			FileInputStream fis = new FileInputStream("F:\\Selenium\\AddProductsAutomationTestingInDevTest\\src\\main\\java\\com\\qa\\addProductsDevTest\\config\\config.properties");
			prop.load(fis);
		} catch(IOException e) {
			e.getMessage();
		}
